...
func (in *AppSpec) DeepCopyInto(out *AppSpec) {
	*out = *in
	...
	if in.SchedulersConfiguration != nil {
		in, out := &in.SchedulersConfiguration, &out.SchedulersConfiguration
		*out = make([]SchedulerConfiguration, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SchedulerConfiguration) DeepCopyInto(out *SchedulerConfiguration) {
	*out = *in
	if in.AffectedRepositoriesRegex != nil {
		in, out := &in.AffectedRepositoriesRegex, &out.AffectedRepositoriesRegex
		*out = make([]string, len(*in))
		copy(*out, *in)
	}

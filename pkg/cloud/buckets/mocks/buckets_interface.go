...
func (mock *MockProvider) UploadFileToBucket(_param0 []byte, _param1 string, _param2 string) (string, error) {
	if mock == nil {
		panic("mock must not be nil. Use myMock := NewMockProvider().")
	}
...
func (verifier *VerifierMockProvider) UploadFileToBucket(_param0 []byte, _param1 string, _param2 string) *MockProvider_UploadFileToBucket_OngoingVerification {
	params := []pegomock.Param{_param0, _param1, _param2}
...
func (c *MockProvider_UploadFileToBucket_OngoingVerification) GetCapturedArguments() ([]byte, string, string) {
	_param0, _param1, _param2 := c.GetAllCapturedArguments()
	return _param0[len(_param0)-1], _param1[len(_param1)-1], _param2[len(_param2)-1]
}

func (c *MockProvider_UploadFileToBucket_OngoingVerification) GetAllCapturedArguments() (_param0 [][]byte, _param1 []string, _param2 []string) {
	params := pegomock.GetGenericMockFrom(c.mock).GetInvocationParams(c.methodInvocations)
	if len(params) > 0 {
